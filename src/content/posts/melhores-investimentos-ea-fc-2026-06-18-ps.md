...
title: "Momentum de Holandeses no EA FC em 18/06 — PS"
draft: false
featured: true
tags:
  - investimentos
  ...
  - previsoes
  - ps
description: "Ranking histórico de momentum em 18/06/2026 no PS: Georginio Wijnaldum liderou 7d com +70,3%. Compare preços, 24h/7d, gráfico e limites."
---
...
**Georginio Wijnaldum** liderou o recorte com **+70,3% em 7d** e +5,0% em 24h. Entre 14 cartas, 14 tinham as duas janelas positivas; a mediana semanal foi **+13,8%**.
...
![Gráfico de variação em 7 dias para os destaques de Momentum de Holandeses no EA FC em 18/06 — PS](/charts/melhores-investimentos-ea-fc-2026-06-18-ps.svg)
...
- **Frank Rijkaard (89)** — 130k coins, **+53.1% em 7 dias** (+16.5% em 24h). Preço +14% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.
...
- **Luciano Valente (87)** — 22k coins, **+28.8% em 7 dias** (+2.7% em 24h). Preço +19% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.
...
Georginio Wijnaldum (87, Brasileirão) lidera, com +70.3% em 7 dias a 25k coins no Console (PS). No recorte, isso descrevia momentum observado, não uma recomendação atual.
...
- [Holandeses no EA FC em 18/06: altas e baixas — PS](/posts/mercado-ea-fc-2026-06-18-ps/)
